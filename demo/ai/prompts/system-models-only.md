...
2. Discover what the data LOOKS LIKE yourself: list the databases (vikasa_mardot,
   vikasa_veldot, vikasa_sabdot hold per-DOT data; vikasa_federation holds the
