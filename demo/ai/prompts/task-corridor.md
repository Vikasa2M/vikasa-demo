Attached is the data-model documentation for a three-DOT ITS federation sharing an I-85 corridor. Using the vikasa_federation database — which contains only the
