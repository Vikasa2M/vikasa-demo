...
Q1. "GDOT cabinet cab-i85-001 lost its network connection earlier today — did we
     ...
     duplicates (the buffered backfill). This is the money shot — the AI
...
Q4. "Are the camera and the lidar at ncdot cab-i85-101 agreeing with each other?"
