...
func TestCabinetLeafService(t *testing.T) {
	cases := map[string]string{
		"cab-i85-001": "gdot-cab-i85-001-nats",
		"cab-002":     "gdot-cab-002-nats",
	}
...
{"Name":"vikasa-demo-gdot-cab-i85-001-nats-1","Service":"gdot-cab-i85-001-nats","Networks":"vikasa-demo_vikasa","Project":"vikasa-demo"}
...
func TestParseComposePSFindsService(t *testing.T) {
	c, err := ParseComposePS([]byte(samplePS), "gdot-cab-i85-001-nats")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if c.Name != "vikasa-demo-gdot-cab-i85-001-nats-1" {
		t.Errorf("Name = %q, want vikasa-demo-gdot-cab-i85-001-nats-1", c.Name)
	}
...
func TestResolveNetworkFallsBackToSibling(t *testing.T) {
	containers := []ComposeContainer{
		{Name: "vikasa-demo-gdot-cab-i85-001-nats-1", Service: "gdot-cab-i85-001-nats", Networks: ""}, // disconnected
		{Name: "vikasa-demo-clickhouse-1", Service: "clickhouse", Networks: "vikasa-demo_vikasa"},
	}
	target, err := FindService(containers, "gdot-cab-i85-001-nats")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveNetworkFallsBackToSiblingStillOnCabinetNet(t *testing.T) {
	containers := []ComposeContainer{
		{Name: "vikasa-demo-gdot-cab-i85-001-nats-1", Service: "gdot-cab-i85-001-nats", Networks: "vikasa-demo_cab-i85-001-net"},
...
func TestResolveNetworkPrefersTargetWhenAttached(t *testing.T) {
	containers := []ComposeContainer{
		{Name: "a", Service: "gdot-cab-i85-001-nats", Networks: "vikasa-demo_vikasa"},
...
func TestResolveNetworkPrefersTargetWhenAttachedToBoth(t *testing.T) {
	containers := []ComposeContainer{
		{Name: "a", Service: "gdot-cab-i85-001-nats", Networks: "vikasa-demo_cab-i85-001-net,vikasa-demo_vikasa"},
	}
	target, err := FindService(containers, "gdot-cab-i85-001-nats")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestResolveNetworkErrorsWhenNoContainerIsAttached(t *testing.T) {
	containers := []ComposeContainer{
		{Name: "a", Service: "gdot-cab-i85-001-nats", Networks: ""},
		{Name: "b", Service: "clickhouse", Networks: ""},
	}
	target, _ := FindService(containers, "gdot-cab-i85-001-nats")
