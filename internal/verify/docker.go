...
// "gdot-cab-i85-001-nats". This is the CABINET LEAF, not the sim: cutting
...
func CabinetLeafService(cabinet string) string {
	return fmt.Sprintf("gdot-%s-nats", cabinet)
}
...
// a cabinet leaf (e.g. gdot-cab-i85-001-nats) is also attached to its
