...
type ConsumerConfig struct {
	NATSURL       string        // e.g. nats://gdot-central:4222
	StreamName    string        // e.g. VIKASA_GDOT_CENTRAL_D1_D1_0
	Durable       string        // e.g. central-sink
	FilterSubject string        // e.g. vikasa.gdot.>
	Database      string        // e.g. vikasa_gdot
	BatchSize     int           // 256
...
// actually happened in production and wedged all 4 sinks until the durables
