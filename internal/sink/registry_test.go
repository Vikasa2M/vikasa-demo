...
func TestRowsPhaseStateChange(t *testing.T) {
	...
	env, err := events.New("gdot", "d1", "cab-i85-001", "asc-1",
...
func TestRowsShareSubjectFallback(t *testing.T) {
	...
	env.Subject = "vikasa.gdot.share.i85.cab-i85-001.signal-control.asc-1.phase-state-change"
...
func TestRowsUnknownTypeErrors(t *testing.T) {
	env := &events.Envelope{Type: "vikasa.bogus.thing.v1",
		Subject: "vikasa.gdot.d1.cab-002.bogus.x-1.thing", ID: "x", Time: time.Now()}
