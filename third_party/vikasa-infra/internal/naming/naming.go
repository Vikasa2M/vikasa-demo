...
// prefix. A well-formed space ends in ".>" (e.g. "vikasa.gdot.d7.>"); the
// match is on a token boundary, so "vikasa.gdot.d70.x" is NOT under
// "vikasa.gdot.d7.>". Mirroring NATS matching, the bare space root
// ("vikasa.gdot.d7") is not matched by ".>" either. A prefix without the
